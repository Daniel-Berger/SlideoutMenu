...
//        setupViewControllers()
        ...
        let tapDismiss = UITapGestureRecognizer(target: self, action: #selector(handleTapDismiss))
//        darkCoverView.gestureRecognizers(tapDismiss)
        darkCoverView.addGestureRecognizer(tapDismiss)
    }
    
    fileprivate func setupViews() {
        view.addSubview(redView) // right side
        view.addSubview(blueView) // left side
...
//            redView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
    ...
    @objc fileprivate func handleTapDismiss(tapGesture: UITapGestureRecognizer) {
        closeMenu()
    }
